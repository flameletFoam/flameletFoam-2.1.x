...
int main(int argc, char *argv[])
{
    ...
    hsReactionThermo& thermo = combustion->thermo();
    ...
    forAll(timeDirs, timeI)
    {
           ...
           forAll(Z, cellI)
           {
         	 if (i == 0)
         	 {
                  ...
                  posIF[cellI] = solver.position(ubIF[cellI], x);
             	  ...
             	  hs[cellI] = solver.interpolate(ubIF[cellI], posIF[cellI], (solver.sizeTableNames() - 1));
         	 }
        ...
        forAll(hs.boundaryField(), patchi)
        {
           ...
           fvPatchScalarField& pHs = hs.boundaryField()[patchi];
           ...
           forAll(Y, i)
           {
               ...
               forAll(pY , facei)
               {
              	 if (i == 0)
              	 {
                      ...
                      pHs[facei] = solver.interpolate(ubP[facei], posP[facei], (solver.sizeTableNames() - 1));
              	 }
